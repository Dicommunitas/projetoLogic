  	...
  	-->
          ...
          <form class="form-horizontal validate" method="POST" data-th-object="${modelAttribute}"
            ...
            <fieldset id="containerFields">
              ...
              <#else>
       	    ...
       	    <#if ((detail.entityName == "ProdutoDevolvido") && (detail.fieldName == "produtosDevolvidos"))>
            <#else>
              <!-- buttons form -->
          ...
          <!-- /FORM -->
              	...
              	window.onload = function() {
    				var all = document.getElementsByClassName("select2-selection--multiple");
               ...
               <#if (detail.entityName == "ProdutoDevolvido")>

        			<#include "unicos/produtodevolvido.html"  parse=false encoding="Shift_JIS">
