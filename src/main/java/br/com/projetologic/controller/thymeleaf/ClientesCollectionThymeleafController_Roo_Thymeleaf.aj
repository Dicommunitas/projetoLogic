...
privileged aspect ClientesCollectionThymeleafController_Roo_Thymeleaf {
    ...
    public void ClientesCollectionThymeleafController.addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        ...
        if (columnName.equals("id")) {
            ...
            builder.addColumn(getMessageSource().getMessage("label_cliente_cnpj", null, "Cnpj", locale), "cnpj", String.class.getName(), 100);
        }
        else if (columnName.equals("nome")) {
            builder.addColumn(getMessageSource().getMessage("label_cliente_nome", null, "Nome", locale), "nome", String.class.getName(), 100);
        }
        else if (columnName.equals("rua")) {
            builder.addColumn(getMessageSource().getMessage("label_cliente_rua", null, "Rua", locale), "rua", String.class.getName(), 100);
        }
        else if (columnName.equals("numero")) {
            builder.addColumn(getMessageSource().getMessage("label_cliente_numero", null, "Numero", locale), "numero", Integer.class.getName(), 100);
        }
        else if (columnName.equals("bairro")) {
            builder.addColumn(getMessageSource().getMessage("label_cliente_bairro", null, "Bairro", locale), "bairro", String.class.getName(), 100);
        }
        else if (columnName.equals("createdDate")) {
            builder.addColumn(getMessageSource().getMessage("label_cliente_createddate", null, "Created Date", locale), "createdDate", Calendar.class.getName(), 100);
        }
        else if (columnName.equals("createdBy")) {
            builder.addColumn(getMessageSource().getMessage("label_cliente_createdby", null, "Created By", locale), "createdBy", String.class.getName(), 100);
        }
        else if (columnName.equals("modifiedDate")) {
            builder.addColumn(getMessageSource().getMessage("label_cliente_modifieddate", null, "Modified Date", locale), "modifiedDate", Calendar.class.getName(), 100);
        }
        else if (columnName.equals("modifiedBy")) {
            builder.addColumn(getMessageSource().getMessage("label_cliente_modifiedby", null, "Modified By", locale), "modifiedBy", String.class.getName(), 100);
        }
        }
